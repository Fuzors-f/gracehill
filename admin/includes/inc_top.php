...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo DOCBASE.ADMIN_FOLDER; ?>/"><?php echo SITE_TITLE; ?><span class="hidden-xs"> | CMS</span></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
                ...
                <ul class="<?php if(array_key_exists($dirname, $indexes)) echo "in"; else echo "collapse"; ?>" role="menu" id="module-menu">
                    ...
                    foreach($modules as $module){
                        ...
                        if(!in_array("no_access", $rights) && !empty($rights)){
                                if($title == "Activities" || $title=="Slideshow" || $title=="Facilities" || $title == "Bookings" || $title == "Rooms" || $title == "Artikel" || $title == "Rates" || $title == "Activity sessions"
                                || $title == "Booking Activity"
                                || $title == "Halaman"
                                || $title == "Konten Email"
                                || $title == "Widgets"
                                //|| $title == "Packages" 
                            //   ||  $title == "Taxes" || $title == "Services"
                                ){
            ...
            if($_SESSION['user']['type'] == "administrator"){ ?>
                ...
                <li>
                    <a href="https://dashboard.tawk.to/?lang=id#/admin/61d98982b84f7301d329fe9c/overview" target="blank">
                            <i class="fas fa-wave-square"></i> Tawk.To
                    </a>
                </li>
                <?php
            } ?>
