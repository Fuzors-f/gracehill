...
define('ADMIN_LANG_FILE', 'ind.ini');
...
define('OWNER', 'Grace Hill Admin');
define('EMAIL', 'test@gmail.com');
define('ADDRESS', 'Grace Hill Villa, Kubuk Minturun<br />Balai Gadang - Kec. Koto Tangah<br />Padang, Sumatera Barat - Indonesia');
define('PHONE', '+62 812-6710-028');
define('MOBILE', '');
define('FAX', '');
define('DB_NAME', 'gracehil_baru');
