...
<div class="box-chat">
	<div class="list-chat">
	    ...
	    <a href="https://wa.me/<?php echo PHONE ?>" target="_blank">
	        	<div  class="img-chat-users"></div>
	    </a>
	</div>
	<div class="list-chat-users rounded-chat">
	    <a href="https://wa.me/<?php echo MOBILE ?>" target="_blank">
	        	<div  class="img-chat-users"></div>
	    </a>
	</div>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/61d98982b84f7301d329fe9c/1foss2a6b';
        s1.charset='UTF-8';
