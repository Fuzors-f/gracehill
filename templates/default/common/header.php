        ...
        <div class="container-fluid">
            ...
            <div class="navbar navbar-default">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo DOCBASE.trim(LANG_ALIAS, "/"); ?>" title="<?php echo $homepage['title']; ?>"><img src="<?php echo getFromTemplate("images/logo-gracehill.png"); ?>" alt="<?php echo SITE_TITLE; ?>"></a>
