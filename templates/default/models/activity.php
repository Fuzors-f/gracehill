                ...
                <div class="col-md-8 mb20">
                    <div class="row mb10">
                        ...
                        <div class="col-sm-4 text-right">
                            ...
                            <div class="price text-primary">
                                <?php
                                    $result_price = $db->query("select * from pm_activity_session where id_activity = ".$activity_id." and start_date <= UNIX_TIMESTAMP( now() ) and end_date >= UNIX_TIMESTAMP( now()) order by price limit 1");
