                        ...
                        <div class="row booking-result activity-result">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3 text-center sep">
                                <div class="price text-primary">
                                    ...
                                    <?php
                                                    $result_price = $db->query("select * from pm_activity_session where id_activity = ".$id_activity." and start_date <= UNIX_TIMESTAMP( now() ) and end_date >= UNIX_TIMESTAMP( now()) order by price limit 1");
                                                    if($result_price !== false && $db->last_row_count() == 1){
                                                        $row_price = $result_price->fetch();
                                                        $price_adult = $row_price['price'];
                                                        $price_children = $row_price['price_child'];
                                                        echo "<hr>";
                                                        echo $texts['ADULT']; ?>
                                                        <span itemprop="priceRange" style="font-size:15pt">
                                                            <?php echo formatPrice($price_adult*CURRENCY_RATE); ?>
                                                        </span>
                                                        / <?php echo $texts['PERSON'];
                                                        echo "<br>";
                                                        echo $texts['CHILDREN']; ?>
                                                        <span itemprop="priceRange" style="font-size:15pt">
                                                            <?php echo formatPrice($price_children*CURRENCY_RATE); ?>
                                                        </span>
                                                        / <?php echo $texts['PERSON'];
                                                        echo "<hr>";
                                                    } else{
